...
(n = this),
  (t = function () {
    ...
    function ct(u, r, i, o) {
      ...
      function b(n) {
        n !== B(o, Hn) &&
          (A(o, Hn, n), v && I(o, Zn, n || null), f(n ? pn : gn, this));
      }
      function x() {
        return u.index === r;
      }
      return {
        ...
        isWithin: function (n, t) {
          return (
            (n = un(n - r)), (n = !u.is(ut) && !m ? $(n, u.length - n) : n) <= t
          );
        },
      };
    }
    ...
    var pt = Object.freeze({
        ...
        Layout: function (n, t, i) {
          ...
          function v() {
            (r = "ttb" === i.direction),
              C(n.root, "maxWidth", V(i.width)),
              C(s, a("paddingLeft"), p(!1)),
              C(s, a("paddingRight"), p(!0)),
              h();
          }
          function h() {
            C(
              ...
              (function () {
                var n = "";
                r &&
                  (Q((n = g()), "height or heightRatio is missing."),
                  (n = "calc(" + n + " - " + p(!1) + " - " + p(!0) + ")"));
                return n;
              })()
            ),
              f.style(a("marginRight"), V(i.gap)),
              f.style(
                "width",
                (i.autoWidth ? "" : V(i.fixedWidth) || (r ? "" : m())) || null
              ),
              f.style(
                "height",
                V(i.fixedHeight) ||
          ...
          return {
            mount: function () {
              v(),
                e(window, "resize load", Sn(c.bind(this, xn))),
                o([bn, _n], v),
                o(xn, h);
            },
            listSize: function () {
        ...
        Controller: function (n, e, u) {
          ...
          function E(n) {
            return (
              R() || ((n = on(n, o - f, o - 1) ? o - 1 : n), (n = tn(n / f))), n
            );
          }
          function z(n) {
            n = a.toIndex(n);
          ...
          function g() {
            ...
            i.arrows &&
              ((v && h) ||
                ...
                (r = !0),
                E(d, [v, h]),
                z(d, O(("slider" === i.arrows && s.slider) || u.root)))),
              v &&
                h &&
                (p.prev
                  ? N(d, !1 === i.arrows ? "none" : "")
        ...
        Drag: function (r, u, o) {
              ...
              (a = n).cancelable &&
                (l
                  ? ((t = 200 < I(n) - I(c)),
                    (i = E !== (E = A())),
                    (t || i) && D(n),
                    m.translate(e + (T(n) - T(c)) / (E && r.is(ut) ? 5 : 1)),
                    h("dragging"),
                    (d = !0),
                    U(n))
                  : ((t = un(T(n) - T(c))),
                    (i = W((i = o.dragMinThreshold))
                      ? i
                      : { mouse: 0, touch: +i || 10 }),
                    (l = t > (F(n) ? i.touch : i.mouse)),
                    O() && U(n)));
          }
          function P(n) {
            var t, i;
          ...
          return {
            mount: function () {
              p(_, ft, Z, L),
                p(_, at, Z, L),
                p(_, "touchstart mousedown", S, L),
                p(_, "click", M, { capture: !0 }),
                p(_, "dragstart", U),
                t([ln, bn], z);
            },
            disable: j,
                  ...
                  l(),
                    n.Slides.forEach(function (u) {
                      J(u.slide, vt).forEach(function (n) {
                        ...
                        (i === n.src && r === n.srcset) ||
                          (I(
                            (t = j("span", o.classes.spinner, n.parentElement)),
                            Vn,
                            "presentation"
                          ),
        ...
        Pagination: function (l, n, d) {
          ...
          function s() {
            var n = a(e(!0)),
              t = a(e());
            n && (K(n.button, Hn), F(n.button, Zn)),
              t && (L(t.button, Hn), I(t.button, Zn, !0)),
      ...
      return (
        (r.mount = function (n, t) {
          ...
          return (
            ...
            r.set(1),
            (this.s = u),
            (this.l = t || this.l || (this.is(et) ? mt : yt)),
            (this.a = n || this.a),
            e(T({}, pt, this.a, { Transition: this.l }), function (n, t) {
              n = n(i, u, i.f);
              (u[t] = n).setup && n.setup();
            }),
            e(u, function (n) {
